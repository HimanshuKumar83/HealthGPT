                    ...
                    <div className="hidden lg:block flex-1">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2.5 mb-10">
                                ...
                                <span className="text-xl font-semibold tracking-tight">HealthGPT</span>
                            </div>
                            ...
                            <p className="text-base text-muted-foreground leading-relaxed max-w-sm mb-10">
                                Join HealthGPT and get access to AI-powered health guidance
                            ...
                            <div className="mt-10 flex items-center gap-3 text-sm text-muted-foreground">
                                ...
                                <div>
                                    ...
                                    <span className="text-xs text-muted-foreground"> users trust HealthGPT</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
