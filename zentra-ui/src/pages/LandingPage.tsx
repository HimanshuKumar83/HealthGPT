            ...
            <div className="hidden md:flex fixed top-0 left-1/2 -translate-x-1/2 z-50 pt-5 w-full justify-center pointer-events-none">
                <div className="flex items-center gap-2 bg-background/80 border border-border backdrop-blur-xl py-1.5 px-2 rounded-full shadow-lg pointer-events-auto">
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold tracking-tight">HealthGPT</span>
                    </button>
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                >
                    HealthGPT is an AI-powered chatbot that answers your health questions using
            ...
            <div className="relative z-10">
                ...
                >
                    ...
                    <p className="mt-5 text-muted-foreground max-w-xl mx-auto leading-relaxed">
                        HealthGPT combines trusted health data with powerful AI to give you
...
const FAQS = [
    {
        q: "Is HealthGPT free to use?",
        a: "Yes — creating an account and using HealthGPT's AI chat is completely free. No credit card required, no hidden fees.",
    },
    {
    ...
    {
        q: "Can HealthGPT replace my doctor?",
        a: "No — HealthGPT provides health information and guidance, but it is not a substitute for professional medical advice. Always consult a healthcare provider for diagnosis and treatment.",
    },
    {
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
                ...
                >
                    ...
                    <p className="mt-4 text-muted-foreground max-w-md mx-auto leading-relaxed text-sm">
                        Everything you need to know about HealthGPT. Can't find what you're looking for? Reach out to us.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-xs text-muted-foreground mb-4">
                        Can't find the answer you're looking for? Get started and ask HealthGPT directly.
                    </p>
                    <button
                        onClick={() => navigate("/register")}
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-muted-foreground max-w-md mx-auto mb-8 leading-relaxed">
                            Join thousands of users who trust HealthGPT for reliable, AI-powered health guidance.
                        </p>
                        <button
                            onClick={() => navigate("/register")}
                            className="group inline-flex items-center gap-2 h-12 px-8 rounded-full
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-14">
                    ...
                    <div className="md:col-span-4">
                        <div className="flex items-center gap-2.5 mb-4">
                            ...
                            <span className="text-lg font-semibold tracking-tight">HealthGPT</span>
                        </div>
